                ...
                @if($active == 1)
                    @if($oldMarks == 0)
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading">Good Natures</div>
                                                ...
                                                <td>
                                                    @foreach($goods as $good)
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="team{{$team->id}}member{{$member->id}}natures[]" value="{{$good->id}}" /> {{$good->serial}}
                                                        </label>
                                                    @endforeach
                                                </td>
                                                <td>
                                                    @foreach($bads as $bad)
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="team{{$team->id}}member{{$member->id}}natures[]" value="{{$bad->id}}" /> {{$bad->serial}}
                                                        </label>
                                                    @endforeach
                                                </td>
                                            </tr>
